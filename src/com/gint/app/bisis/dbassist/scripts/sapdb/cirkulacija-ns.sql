...
CREATE TABLE users( id INTEGER NOT NULL, city VARCHAR(45) UNICODE NULL, zipcode INTEGER NULL, address VARCHAR(150) UNICODE NULL, sign_date DATE NULL, warning NUMBER(1) NULL, phone VARCHAR(50) UNICODE NULL, email VARCHAR(50) UNICODE NULL, user_type INTEGER NOT NULL, branch_id INTEGER NULL, branch_card VARCHAR(20) UNICODE NULL, branch_sign_date DATE NULL, PRIMARY KEY (id), FOREIGN KEY (user_type) REFERENCES USER_TYPES (id), FOREIGN KEY (branch_id) REFERENCES BRANCH (id))
