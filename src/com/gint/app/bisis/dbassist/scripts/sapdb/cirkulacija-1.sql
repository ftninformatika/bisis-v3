...
CREATE TABLE users( id INTEGER NOT NULL, city VARCHAR(45) UNICODE NULL, zipcode INTEGER NULL, address VARCHAR(150) UNICODE NULL, sign_date DATE NULL, warning NUMBER(1) NULL, phone VARCHAR(100) UNICODE NULL, email VARCHAR(30) UNICODE NULL, user_type INTEGER NOT NULL, branch_id INTEGER NULL, branch_card VARCHAR(20) UNICODE NULL, branch_sign_date DATE NULL, PRIMARY KEY (id), FOREIGN KEY (user_type) REFERENCES USER_TYPES (id), FOREIGN KEY (branch_id) REFERENCES BRANCH (id))
...
CREATE TABLE slikovnice( user_id INTEGER NOT NULL, datum DATE NOT NULL, izdato INTEGER NULL, vraceno INTEGER NULL, stanje INTEGER NULL, bib_id CHAR(50) UNICODE NOT NULL, PRIMARY KEY (user_id, datum), FOREIGN KEY (user_id) REFERENCES SINGLE (user_id))
