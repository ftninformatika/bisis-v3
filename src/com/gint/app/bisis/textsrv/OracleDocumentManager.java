...
/**  Klasa OracleDocumentManager implementira DocumentManager
  *  interfejs za potrebe rada sa bazom Oracle Server (verzije 7 i vise).
  *  @author Branko Milosavljevic
  *  @author mbranko@uns.ns.ac.yu
  *  @version 1.0
  *  @see DocumentManager
  */
public class OracleDocumentManager implements DocumentManager {
  ...
  /**  Konstruise objekat sa datim parametrima.
    ...
    */
  public OracleDocumentManager(Connection conn) {
    this.conn = conn;
  ...
  public OracleDocumentManager(OracleDocumentManager odm, Connection conn) {
    this.wp = odm.wp;
    this.dp = odm.dp;
    conv = new UnimarcConverter();
  ...
  public int insertDocument(String doc) {
    ...
    try {
      ...
      ((oracle.jdbc.driver.OracleStatement)pstmt).defineColumnType(1, Types.LONGVARBINARY);
      ...
      ((oracle.jdbc.driver.OracleStatement)pstmt).defineColumnType(1, Types.INTEGER);
      ...
      ((oracle.jdbc.driver.OracleStatement)pstmt).defineColumnType(1, Types.CHAR);
      ((oracle.jdbc.driver.OracleStatement)pstmt).defineColumnType(2, Types.INTEGER);
      ((oracle.jdbc.driver.OracleStatement)pstmt).defineColumnType(3, Types.LONGVARBINARY);
      ...
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(1, Types.VARCHAR);
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(2, Types.VARCHAR);
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(3, Types.INTEGER);
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(4, Types.VARCHAR);
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(5, Types.VARCHAR);
  ...
  public int updateDocument(int doc_id, String doc) {
    ...
    try {
      ...
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(2, Types.VARCHAR);
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(3, Types.INTEGER);
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(4, Types.INTEGER);
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(5, Types.VARCHAR);
      ((oracle.jdbc.driver.OracleStatement)pstmt2).defineColumnType(6, Types.VARCHAR);
  ...
  public com.objectspace.jgl.HashSet executeSelect(String prefix, String term) {
    ...
    if (prefix != null) {
      if (prefix.equals("ID")) {
        try {
          ...
          ((oracle.jdbc.driver.OracleStatement)selectStatement).defineColumnType(1, Types.INTEGER);
    ...
    try {
      selectStatement = conn.createStatement();
      ((oracle.jdbc.driver.OracleStatement)selectStatement).defineColumnType(1, Types.INTEGER);
      ((oracle.jdbc.driver.OracleStatement)selectStatement).defineColumnType(2, Types.INTEGER);
      ((oracle.jdbc.driver.OracleStatement)selectStatement).defineColumnType(3, Types.INTEGER);
      ((oracle.jdbc.driver.OracleStatement)selectStatement).defineColumnType(4, Types.INTEGER);
  ...
  public Vector expand(String prefix, String query) {
    ...
    try {
      ...
      ((oracle.jdbc.driver.OracleStatement)expandStatement).defineColumnType(1, Types.LONGVARBINARY);
      ResultSet rset = expandStatement.executeQuery(queryStr);
      while (rset.next()) {
        String temp = StringUtils.getStringLower(rset.getBytes(1));
  ...
  public void getDocsRange(int[] docIDs, String[] docs) {
    ...
    try {
      ...
      while (rset.next()) {
        ...
        docs[i++] = StringUtils.getStringLower(rset.getBytes(2));
      }
      rset.close();
      stmt.close();
    } catch (SQLException ex) {
      ...
      if (rset.next()) {
      	...
      	if (bytes == null)
      		retVal = "";
				  ...
				  retVal = StringUtils.getStringLower(bytes);
      }
      else
        retVal = "";
      rset.close();
