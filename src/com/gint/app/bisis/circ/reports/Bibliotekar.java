 ...
 *
 */
public class Bibliotekar extends EscapeDialog {
  ...
  public Bibliotekar(Frame frame, String title, boolean modal, DBConnection db) {
  ...
  public Bibliotekar(String title, DBConnection dbConn, boolean modal) {
  ...
  void jbInit() throws Exception {
    ...
    jLabel2.setText(Messages.get("BIBLIOTEKAR_JLABEL2_TEXT"));
    ...
    panel1.add(jLabel2, new XYConstraints(106, 43, -1, -1));
...
//        System.setProperty("jasper.reports.compile.class.path", classPath);
        ...
        JasperPrint jp = JasperFillManager.fillReport(
          Bibliotekar.class.getResource(
            "/com/gint/app/bisis/circ/reports/bibliotekar.jasper").openStream(), 
            params, dbConn.getConnection());
//        JasperReport jr = JasperCompileManager.compileReport(Bibliotekar.class
//                .getResource("/com/gint/app/bisis/circ/reports/bibliotekar.jrxml")
//                .openStream());
