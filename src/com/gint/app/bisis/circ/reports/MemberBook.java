...
public class MemberBook extends EscapeDialog {
	  ...
	  public MemberBook(Frame frame, String title, boolean modal, DBConnection db) {
	  ...
	  public MemberBook(String title, DBConnection dbConn, boolean modal) {
	  ...
	  void jbInit() throws Exception {
	    ...
	    label1.setText(Messages.get("MEMBERBOOK_LABEL1_TEXT"));
	    jLabel2.setText(Messages.get("MEMBERBOOK_JLABEL2_TEXT"));
	    jLabel2.setForeground(Color.blue);

	    buttonOK.setText(Messages.get("MEMBERBOOK_BUTTONOK_TEXT"));
	    buttonCancel.setText(Messages.get("MEMBERBOOK_BUTTONCANCEL_TEXT"));
	      ...
	      try {
	      	...
	      	JasperReport subreport = (JasperReport)JRLoader.loadObject(
	                MemberBook.class.getResource(
	                  "/com/gint/app/bisis/circ/reports/submemberbook.jasper").openStream());  	
...
//	        System.setProperty("jasper.reports.compile.class.path", classPath);
	        ...
	        JasperPrint jp = JasperFillManager.fillReport(
	            MemberBook.class.getResource(
	                "/com/gint/app/bisis/circ/reports/memberbook.jasper").openStream(), 
