 ...
 *
 */
public class Kategorija extends EscapeDialog {
  ...
  public Kategorija(Frame frame, String title, boolean modal, DBConnection db) {
  ...
  public Kategorija(String title, DBConnection dbConn, boolean modal) {
  ...
  void jbInit() throws Exception {
    ...
    label1.setText(Messages.get("KATEGORIJA_LABEL1_TEXT"));
    jLabel2.setText(Messages.get("KATEGORIJA_JLABEL2_TEXT"));
    jLabel2.setForeground(Color.blue);

    buttonOK.setText(Messages.get("KATEGORIJA_BUTTONOK_TEXT"));
    buttonCancel.setText(Messages.get("KATEGORIJA_BUTTONCANCEL_TEXT"));
...
//        System.setProperty("jasper.reports.compile.class.path", classPath);
        ...
        JasperPrint jp = JasperFillManager.fillReport(
            Kategorija.class.getResource(
                "/com/gint/app/bisis/circ/reports/kategorija.jasper").openStream(), 
