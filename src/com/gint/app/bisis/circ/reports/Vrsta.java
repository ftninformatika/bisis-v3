 ...
 *
 */
public class Vrsta extends EscapeDialog {
  ...
  public Vrsta(Frame frame, String title, boolean modal, DBConnection db) {
  ...
  public Vrsta(String title, DBConnection dbConn, boolean modal) {
  ...
  void jbInit() throws Exception {
    ...
    label1.setText(Messages.get("VRSTA_LABEL1_TEXT"));
    jLabel2.setText(Messages.get("VRSTA_JLABEL2_TEXT"));
    jLabel2.setForeground(Color.blue);

    buttonOK.setText(Messages.get("VRSTA_BUTTONOK_TEXT"));
    buttonCancel.setText(Messages.get("VRSTA_BUTTONCANCEL_TEXT"));
...
//        System.setProperty("jasper.reports.compile.class.path", classPath);
        ...
        JasperPrint jp = JasperFillManager.fillReport(
            Vrsta.class.getResource(
                "/com/gint/app/bisis/circ/reports/vrsta.jasper").openStream(), 
                params, dbConn.getConnection());
//        JasperReport jr = JasperCompileManager.compileReport(Vrsta.class.getResource(
//        	"/com/gint/app/bisis/circ/reports/vrsta.jrxml").openStream());
