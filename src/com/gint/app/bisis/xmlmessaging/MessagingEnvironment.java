...
public class MessagingEnvironment {
	private static LinkedHashMap libServers;
	private static LinkedHashMap actions;
	private static LibraryServerDesc myLibServer;
	private static String mainURL;
	public static int DEBUG=0;
	
	
	private static String reqSchemaURL="http://bisis.ns.ac.yu/schemas/bisisXMLM/bisis_req.xsd";
	private static String respSchemaURL="http://bisis.ns.ac.yu/schemas/bisisXMLM/bisis_resp.xsd";
	 ...
	 */
	public static LinkedHashMap getLibServers() {
		return libServers;
	}
	/**
