...
//      comparator = RegistryUtils.getCyrComparator();
  ...
  public void setVisible(boolean visible) {
    if (visible) {
      try {
        connection = DriverManager.getConnection(Environment.getURL(), 
