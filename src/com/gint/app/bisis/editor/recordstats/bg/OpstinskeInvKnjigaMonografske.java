...
public class OpstinskeInvKnjigaMonografske extends RecordReport {
  ...
  public void execute() {
    ...
    try {
      if (DEBUG) {
        ...
        // ucitaj sifarnik ogranaka
        Statement stmt = conn.createStatement();
        ResultSet rset = stmt.executeQuery(
            "SELECT isid, is_naziv FROM interni_sifarnik " +
            "WHERE ppo_po_poljeid='996' AND ppo_potpoljaid='w'");
        while (rset.next()) {
          ogranci.put(rset.getString(1), rset.getString(2));
        }
        rset.close();
        stmt.close();
      ...
      JasperPrint jp = JasperFillManager.fillReport(
          OpstinskeInvKnjigaMonografske.class.getResource(
            "/com/gint/app/bisis/editor/recordstats/bg/OpstinskeInvKnjigaMonografske.jasper")
...
//        continue;
  ...
  private String getOgranak(String s) {
    String naziv = (String)ogranci.get(s);
    if (naziv != null)
      return naziv;
    else
      return " ";
      //return "\u041d\u0435\u043f\u043e\u0437\u043d\u0430\u0442 \u043e\u0433\u0440\u0430\u043d\u0430\u043a: " + s; // Nepoznat ogranak
  }
