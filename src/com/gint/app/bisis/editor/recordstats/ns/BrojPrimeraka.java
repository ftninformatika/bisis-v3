 ...
 * @author branko
 */
public class BrojPrimeraka extends ServerReport {

  public void execute() throws Exception {
    String url = Environment.getReportServlet() + 
        "/OfflineReport?reportFile=BrojPrimeraka.xml";
    ...
    report = JasperFillManager.fillReport(
        BrojPrimeraka.class.getResource(
          "/com/gint/app/bisis/editor/recordstats/ns/BrojPrimeraka.jasper")
