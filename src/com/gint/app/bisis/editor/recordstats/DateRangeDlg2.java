...
public class DateRangeDlg2 extends JDialog {

  public DateRangeDlg2(JFrame parent) {
    ...
    box2.add(new JLabel("Broj prve strane: "));
    box3.add(tfFrom);
    box3.add(tfTo);
    box3.add(tfStartPage);
    box1.add(box2);
    box1.add(box3);
  ...
  public void handleOK() {
    try {
      ...
      startPage = Integer.parseInt(tfStartPage.getText().trim());
      startDate = start;
      endDate = end;
      cancelled = false;
      setVisible(false);
    } catch (Exception ex) {
      JOptionPane.showMessageDialog(this, "Neispravan unos!", "Gre\u0161ka", 
  ...
  private JTextField tfStartPage = new JTextField(12);
