...
><#list f997 as field
    ...
    ><#if word=val || (val="" && past=word)        
            ...
            ><#if invM!=""
               ><#assign invM="&nbsp;:&nbsp;"+invM
            ></#if 
            ><#assign inv=inv+invF+invJ+invK+invM+"<BR>"           
...
><#list f996 as field
    ...
    ><@field996FF field/><#--
    --><#assign pomInv=val
    ><#if tekucaSig=val || (val="" && past=tekucaSig)        
            ><#assign val=""
            ><#assign allSF="f"
            ><@field996FF field/><#--
            --><#if val!=""
    ...
    ><#assign past=pomInv
></#list
><#assign word=tekucaSig
></#macro

><#macro polje996potpoljeR
><#assign pomR=""
><#assign past=""
><#list f996 as field
